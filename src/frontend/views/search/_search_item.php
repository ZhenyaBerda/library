...
<li>
    ...
    $extraData = [];
    $publisherData = [];
    $publisherFields = ['getConference_city', 'getConference_date', 'getPublisher_name', 'getPublisher_city', 'getPublisher', 'getPublisher_number', 'getYear', 'getPublisher_pages'];
    $textLink = '';
    $authorsList = [];
   ...
   if (!Yii::$app->user->isGuest) {
    if(Yii::$app->user->identity->username == 'Admin')
        echo ' | ' . Html::a('Редактировать', ['/publication/update', 'id' => $model->id]);
